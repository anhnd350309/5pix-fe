...
export const getGetUsersGetQueryKey = (params?: GetUsersGetParams,) => {
    return [`https://api.5pix.org/users`, ...(params ? [params]: [])] as const;
    }
...
export const detailMeUsersMeGet = (
    ...
    return axios.get(
      `https://api.5pix.org/users/me`,options
    );
  }


export const getDetailMeUsersMeGetQueryKey = () => {
    return [`https://api.5pix.org/users/me`] as const;
    }
...
export const detailUsersUserIdGet = (
    ...
    return axios.get(
      `https://api.5pix.org/users/${userId}`,options
    );
  }


export const getDetailUsersUserIdGetQueryKey = (userId: number,) => {
    return [`https://api.5pix.org/users/${userId}`] as const;
    }
...
export const updateUsersUserIdPut = (
    ...
    return axios.put(
      `https://api.5pix.org/users/${userId}`,
