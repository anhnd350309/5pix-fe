...
export const get5pixBackend = () => {
  ...
  const getHealthcheckGet = <TData = AxiosResponse<ResponseSchemaBase>>(
    ...
    return axios.get(`/healthcheck`, options)
  }
  ...
  const uploadToGetCdnBasePost = <TData = AxiosResponse<DataResponseImageCdn>>(
    ...
    return axios.post(`/base`, formData, options)
  }
  ...
  const loginAccessTokenLoginPost = <TData = AxiosResponse<DataResponseToken>>(
    ...
    return axios.post(`/login`, loginRequest, options)
  }
  ...
  const registerRegisterPost = <TData = AxiosResponse<DataResponseUserItemResponse>>(
    ...
    return axios.post(`/register`, userRegisterRequest, options)
  }
  ...
  const updateMeUsersMePut = <TData = AxiosResponse<DataResponseUserItemResponse>>(
    ...
    return axios.put(`/users/me`, userUpdateMeRequest, options)
  }
  ...
  const updateUsersUserIdPut = <TData = AxiosResponse<DataResponseUserItemResponse>>(
    ...
    return axios.put(`/users/${userId}`, userUpdateRequest, options)
  }
  ...
  const createAlbumsPost = <TData = AxiosResponse<DataResponseAlbumItemResponse>>(
    ...
    return axios.post(`/albums`, albumCreateRequest, options)
  }
  ...
  const updateAlbumsAlbumIdPut = <TData = AxiosResponse<DataResponseAlbumItemResponse>>(
    ...
    return axios.put(`/albums/${albumId}`, albumUpdateRequest, options)
  }
  ...
  const updateAlbumsAlbumIdProcessImagePut = <TData = AxiosResponse<DataResponseStr>>(
    ...
    return axios.put(`/albums/${albumId}/process-image`, undefined, options)
  }
  ...
  return {
    ...
    detailMeUsersMeGet,
    updateMeUsersMePut,
    detailUsersUserIdGet,
    updateUsersUserIdPut,
    getAlbumsGet,
    createAlbumsPost,
    updateAlbumsAlbumIdPut,
    updateAlbumsAlbumIdProcessImagePut,
    searchAlbumImagesGet,
  }
}
...
export const getGetHealthcheckGetResponseMock = (
  overrideResponse: Partial<ResponseSchemaBase> = {},
): ResponseSchemaBase => ({
...
export const getGetAlbumsGetResponseMock = (
  ...
  code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
  data: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    album_image_url: faker.string.alpha(20),
    album_name: faker.string.alpha(20),
    created_at: `${faker.date.past().toISOString().split('.')[0]}Z`,
    event_date: `${faker.date.past().toISOString().split('.')[0]}Z`,
    id: faker.number.int({ min: undefined, max: undefined }),
    is_highlight: faker.number.int({ min: undefined, max: undefined }),
    total_image: faker.helpers.arrayElement([
...
export const getCreateAlbumsPostResponseMock = (
  overrideResponse: Partial<DataResponseAlbumItemResponse> = {},
...
export const getUpdateAlbumsAlbumIdPutResponseMock = (
  overrideResponse: Partial<DataResponseAlbumItemResponse> = {},
): DataResponseAlbumItemResponse => ({
  code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
  data: faker.helpers.arrayElement([
...
export const getUpdateAlbumsAlbumIdProcessImagePutResponseMock = (
  overrideResponse: Partial<DataResponseStr> = {},
): DataResponseStr => ({
  code: faker.helpers.arrayElement([faker.string.alpha(20), undefined]),
...
export const getGetHealthcheckGetMockHandler = (
  overrideResponse?:
    | ResponseSchemaBase
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<ResponseSchemaBase> | ResponseSchemaBase),
) => {
  return http.get('*/healthcheck', async (info) => {
    await delay(1000)
...
export const getGetAlbumsGetMockHandler = (
  overrideResponse?:
    | PageAlbumItemResponse
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<PageAlbumItemResponse> | PageAlbumItemResponse),
) => {
...
export const getCreateAlbumsPostMockHandler = (
  overrideResponse?:
    | DataResponseAlbumItemResponse
    | ((
        info: Parameters<Parameters<typeof http.post>[1]>[0],
      ) => Promise<DataResponseAlbumItemResponse> | DataResponseAlbumItemResponse),
) => {
  return http.post('*/albums', async (info) => {
    await delay(1000)
...
export const getUpdateAlbumsAlbumIdPutMockHandler = (
  overrideResponse?:
    | DataResponseAlbumItemResponse
    | ((
        info: Parameters<Parameters<typeof http.put>[1]>[0],
  ...
  return http.put('*/albums/:albumId', async (info) => {
    await delay(1000)
...
export const getUpdateAlbumsAlbumIdProcessImagePutMockHandler = (
  overrideResponse?:
    | DataResponseStr
    | ((
        info: Parameters<Parameters<typeof http.put>[1]>[0],
      ) => Promise<DataResponseStr> | DataResponseStr),
) => {
  return http.put('*/albums/:albumId/process-image', async (info) => {
    await delay(1000)
