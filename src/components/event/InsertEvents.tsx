    ...
    <div className='p-4 flex flex-col gap-6'>
      ...
      <div className='w-1/2 shadow-lg shadow-gray-500/50 p-4 rounded-2xl'>
        ...
        >
          ...
          <Form.Item name='allowViewAllImages' valuePropName='checked'>
            <div className='flex gap-2 w-full items-center'>
              <div className='flex justify-end w-[250px]'>
          ...
          <Form.Item name='allowFaceSearch' valuePropName='checked'>
            <div className='flex gap-2 w-full items-center'>
              <div className='flex justify-end w-[250px]'>
          ...
          <Form.Item name='allowBibTextSearch' valuePropName='checked'>
            <div className='flex gap-2 w-full items-center'>
              <div className='flex justify-end w-[250px]'>
          ...
          <Form.Item name='highlightEvent' valuePropName='checked'>
            <div className='flex gap-2 w-full items-center'>
              <div className='flex justify-end w-[250px]'>
