  ...
  return (
    <div className='bg-template-white-300 pb-24 pt-44'>
      <div className='container mx-auto grid w-full grid-flow-row grid-cols-3 grid-rows-4 gap-4 px-8 sm:grid-flow-col sm:grid-cols-12 sm:grid-rows-1 xl:px-16'>
        <div className='col-span-12 flex flex-col items-center sm:items-start sm:col-span-4 sm:col-end-5 '>
          <Image
        ...
        <div className='col-span-12 row-span-2 flex flex-col sm:col-span-2 sm:col-start-7 sm:col-end-10 gap-4'>
          <p className='font-sans text-xl font-bold leading-7 tracking-[0.005em] text-left underline-offset-auto [text-decoration-skip-ink:none]'>Contact</p>
            ...
            <li className='font-sans text-base font-normal leading-6 tracking-[0.002em] text-left underline-offset-auto [text-decoration-skip-ink:none] mb-3'>
              ...
              <Image
                ...
                width={30}
              />
              <span className="text-sm">Tầng 9, Hồ Gươm Plaza (tòa văn phòng), Số 102 Trần Phú, Quận Hà Đông, Thành Phố Hà Nội , Việt Nam.</span>
              </div>
            </li>
            </ul>
        </div>
        ...
        <div className='col-span-12 flex flex-col sm:col-span-3 sm:col-start-10 sm:col-end-13'>
          <p className='font-sans text-xl font-bold leading-7 tracking-[0.005em] text-left underline-offset-auto [text-decoration-skip-ink:none]'>Social media</p>
